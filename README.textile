...
That should be all you need to do - start up the dev web server, or whatever. The relevant bits of my Apache VirtualHost, for what it's worth, are as follows:
